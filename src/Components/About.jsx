          ...
          <div class="parallax2">
            <div className='abouts'>
              ...
              <div className='about' id='about'>
                ...
                <p>I specialize in HTML, CSS, JavaScript, React, Node.js, and Python. I have extensive experience with responsive design, API integration, and datab~ase management.</p>
              </div>
              <div className='edu'>
                <h1>Education</h1>
